...
Token state is stored in a network specific tokens file (for example `~/.bitelectronero/testnet/tokens.bin`) and kept in sync across nodes. Each operation remains private thanks to ring signatures and normal transaction handling.
